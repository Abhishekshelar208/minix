      ...
      DocumentTemplate(
        ...
        sections: [
          DocumentSection(
            ...
            order: 1,
            isRequired: true,
            placeholder: 'System overview, architecture summary',
          ),
          DocumentSection(
            ...
            order: 2,
            isRequired: true,
            placeholder: 'Detailed architecture, component diagrams',
          ),
          DocumentSection(
            id: 'database_section',
            title: 'Database Design',
            ...
            order: 3,
            isRequired: true,
            placeholder: 'Schema, relationships, data flow',
          ),
          DocumentSection(
            id: 'api_section',
            ...
            order: 4,
            isRequired: true,
            placeholder: 'Endpoints, request/response formats',
          ),
          DocumentSection(
            id: 'security_section',
          ...
          DocumentSection(
            ...
            order: 6,
            isRequired: true,
            placeholder: 'Load handling, response times, scalability',
          ),
          DocumentSection(
            ...
            order: 7,
            isRequired: true,
            placeholder: 'Environment setup, configuration, hosting',
          ),
          DocumentSection(
            ...
            order: 8,
            isRequired: true,
            placeholder: 'Updates, monitoring, troubleshooting',
          ),
        ],
        formatting: DocumentFormatting(
          fontFamily: 'Arial',
